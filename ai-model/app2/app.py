...
def handle_exception(e):
    if isinstance(e, HTTPException):
        return jsonify(error=e.name, description=e.description, success=False), e.code
    return jsonify(error="Internal Server Error", description=str(e), success=False), 500
